...
from decouple import AutoConfig, Choices, Config, Csv, RepositoryEnv
...
# Ebay API settings
EBAY_API_ENV = config(
    "EBAY_API_ENV", default="sandbox", cast=Choices(["sandbox", "production", "mock"])
)
EBAY_CLIENT_ID_SANDBOX = config("EBAY_CLIENT_ID_SANDBOX", default="")
EBAY_CLIENT_SECRET_SANDBOX = config("EBAY_CLIENT_SECRET_SANDBOX", default="")
EBAY_CLIENT_ID_PRODUCTION = config("EBAY_CLIENT_ID_PRODUCTION", default="")
EBAY_CLIENT_SECRET_PRODUCTION = config("EBAY_CLIENT_SECRET_PRODUCTION", default="")
EBAY_MOCK_SERVER_URL = config("EBAY_MOCK_SERVER_URL", default="")
...
SPECTACULAR_SETTINGS = {
    ...
    "SERVERS": [
        {"url": config("SPECTACULAR_SERVER_URL"), "description": "Local server"}
    ],
}
